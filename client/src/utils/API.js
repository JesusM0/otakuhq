...
export const getKitsuTrending = fetch(
...
export const getKitsuCategories = fetch('https://kitsu.io/api/edge/categories');
...
export const getCategoryFavorites = fetch(
  'https://kitsu.io/api/edge/category-favorites'
);
